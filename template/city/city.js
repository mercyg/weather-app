...
app.service("CityService", ["$http", function($http) {
    ...
    this.cityWeather = function(state) {
        var baseUrl = "https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?q=" + state + "&mode=json&appid=18a926c00a15bf7072316e88506a8add&units=imperial"
