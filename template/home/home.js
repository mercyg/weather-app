...
//    this.suggest = function(long, lat){
//        var baseUrl = "https://maps.googleapis.com/maps/api/place/nearbysearch/json?location=" + lat + "," + long + "&radius=500&type=restaurant&keyword=cruise&key=AIzaSyDSS00-c1G0-ETEZQSyDuapuuxpJc89iXk";
//        return $http.get(baseUrl)
//    }
